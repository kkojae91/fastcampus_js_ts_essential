...
for (var _i = 0, _cartItems = cartItems; _i < _cartItems.length; _i++) {
  var item = _cartItems[_i];
  var row = []; // 객체 안의 key, value를 꺼내올 수 있는 방법
...
console.log(cartItemsArray.join("===")); // 배열연산을 이용한 방법

var extractValueInObject = function extractValueInObject(obj) {
