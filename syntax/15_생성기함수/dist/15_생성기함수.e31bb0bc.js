...
var _marked = /*#__PURE__*/regeneratorRuntime.mark(infiniteEnergyGenerator);

function makeInfiniteEnergyGenerator() {
  var energy = 0;
  return function () {
    var booster = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
...
function infiniteEnergyGenerator() {
  var energy, booster;
  return regeneratorRuntime.wrap(function infiniteEnergyGenerator$(_context) {
    while (1) {
...
var energyGenerator = infiniteEnergyGenerator();
...
//# sourceMappingURL=/15_생성기함수.e31bb0bc.js.map