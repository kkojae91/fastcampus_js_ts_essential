...
var CartV2 = // static 인스턴스 객체에는 드라나지 않고 class자체에 붙어 있는 속성.
function CartV2() {
  var _this = this;
...
_defineProperty(CartV2, "createItem", function (name, price) {
  return {
    name: name,
    price: price
  };
