...
function () {
  ...
  Object.defineProperty(Shape.prototype, "borderWidth", {
    get: function get() {
...
function (_super) {
  ...
  function Circle(radius) {
    var _this = // super(); 를 입력해줘야 부모의 생성자가 작동하게 됩니다.(Shape 클래스의 생성자가 작동!)
    _super.call(this) || this; // 부모가 가지고 있는 속성을 재정의 하면 오버라이딩이 된다.(덮어씌운다.)


    _this.name = "Circle"; // 부모의 추상 매소드를 실제 구현하는 코드 무조건 실체화된 코드를 구현해줘야한다.
...
function (_super) {
  ...
  function Rect(width, height) {
    ...
    _this.area = function () {
      return _this._width * _this._height;
    };
...
/** @class */
function () {
  function MyContainer(tagName, className) {
    var _this = this;
