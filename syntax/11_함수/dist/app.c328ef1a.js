...
var result2 = myFn2(10); // 이름이 없는 함수 -> 반드시 변수에 넣어야 사용할 수 있다.
// 함수 자체를 값으로 만들 수 있다.

var myFn3 = function myFn3() {
  return 100;
...
function sum() {
  ...
  for (var i = 0; i < arguments.length; i++) {
    s += i < 0 || arguments.length <= i ? undefined : arguments[i];
  }
...
var abcSum = sum(10, 20, 30, 40);
var arr = [10, 20, 30, 40, 50]; // 함수 호출 방법은 아래와 같이 3가지.

myFn3();
sum.call(null, 10, 20, 30);
sum.apply(null, arr); // 즉시 실행하는 함수
...
var sumV2 = function sumV2(a, b) {
  var s = 0;

  for (var i = 0; arguments.length <= 2 ? 0 : arguments.length - 2; i++) {
    s += i + 2 < 2 || arguments.length <= i + 2 ? undefined : arguments[i + 2];
  }
  ...
  return regeneratorRuntime.wrap(function gen$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 4:
          return _context.abrupt("return", 30);
...
function myTask() {
  return _myTask.apply(this, arguments);
}

function _myTask() {
  _myTask = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
