...
var books = ["헨리 6세", "리처드 3세", "실수 연발", "말괄량이 길들이기", "헨리 8세"]; // forEach 순회 배열의 첫번째 부터 마지막까지 하나씩 순회하는 것.
// 배열이 제공하는 함수를 사용
...
var ShakespeareOneBooks = books // 객체를 값으로서 return 한 다음 그 값을 다시 map 함수를 활용
.map(function (book) {
  return {
    title: book
  };
...
console.log(sumNumbers(10, 20, 30, 40, 50)); // 전개파라미터인 ...args를 사용하면 바로 배열로써의 역할을 할 수 있다.
